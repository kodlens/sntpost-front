...
import '../../../../public/magazines/js/libs/jquery.min.js';
//import './libs/jquery.min.js';
import '../../../../public/magazines/js/flip.min.js'
...
const MagazinePDFFlipBook:React.FC = () => {
    ...
    const loadMagazine = () => {
        setLoading(true)
        axios.get<Magazine>(`${config.baseUri}/api/magazines/get-magazine/${slug}`,{
            headers: {
    ...
    const initFlip = () => {
        if (typeof $ !== 'undefined' && $('#flipbookContainer').flipBook) {
            const options = {
                height: 2000,
                duration: 700,
                backgroundColor: '#2F2D2F'
            ...
            console.warn('flipBook not initialized: jQuery or plugin is missing.');
        }
    }
